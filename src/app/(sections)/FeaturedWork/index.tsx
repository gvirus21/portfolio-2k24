...
export const FeaturedWorkSection = () => {
  return (
    <Element name="featured-work-section">
      <section className="relative left-[50%] -translate-x-[50%] flex justify-between lg:max-h-[80rem] xl:max-h-[80rem] 2xl:max-h-[80rem] 3xl:max-h-[100rem] lg:h-[150vh] xl:h-[160vh] 2xl:h-[150vh] 3xl:h-[200vh] w-11/12 max-w-[140rem] mt-[8rem] 2xl:mt-40">
