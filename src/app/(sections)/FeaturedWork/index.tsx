...
export const FeaturedWorkSection = ({ timeline }: Props) => {
  return (
    <Element name="featured-work-section">
      <section className="relative left-[50%] -translate-x-[50%] flex justify-between min-h-[90vh] lg:min-h-0 lg:max-h-[75rem] xl:max-h-[85rem] 3xl:h-[100rem] 3xl:max-h-[100rem] w-11/12 max-w-[140rem] mt-[8rem] 2xl:mt-40">
