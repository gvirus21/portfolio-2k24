...
export const InfiniteScrollButton = () => {
  ...
  return (
    <div
      ...
      className="hidden sm:flex justify-start items-center py-1 sm:h-10 md:h-12 w-[10rem] md:w-[12rem] xl:w-[15rem] border-2 border-black rounded-full mt-7 sm:mt-10 lg:mt-12 xl:mt-16 2xl:mt-20 3xl:mt-32 overflow-hidden --pl-2 opacity-0 ml-10 -mr-10"
    >
