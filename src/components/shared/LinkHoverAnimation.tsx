    ...
    >
      ...
      <div className="flex flex-col pt-2">
        <div className="relative w-full">
          <div
            className={cn(
              "absolute right-0 text-black h-[2px] transition-all duration-500 ease-out bg-black",
        ...
        <div className="relative w-full">
          <div
            className={cn(
              "absolute left-0 text-black h-[2px] transition-all duration-500 delay-150 ease-out text-right bg-black",
