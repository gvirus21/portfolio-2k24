...
const Loader = ({ timeline }: Props) => {
  ...
  return (
    ...
    >
      <div className="relative h-[70%] md:h-screen w-screen">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[70%] md:-translate-y-1/2 h-[15.6rem] overflow-hidden text-black">
          <div
