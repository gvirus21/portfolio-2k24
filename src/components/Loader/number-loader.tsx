...
const NumberLoader = ({ timeline }: Props) => {
  ...
  return (
    <div
      ...
      className="for-gsap-loading-number-container absolute bottom-10 left-1/2 -translate-x-1/2 md:left-20 md:translate-x-0 flex h-[5rem] w-[9rem] text-black text-[3.5rem] overflow-hidden"
    >
